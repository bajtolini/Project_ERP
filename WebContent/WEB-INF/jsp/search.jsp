...
<body>
	<div
		...
		<h2 class="w3-center">${info}</h2>
		<c:if test="${empty clients}">
			<h2 class="w3-center">Nie ma klientów</h2>
		</c:if>

		<table class="w3-table-all w3-striped w3-bordered w3-border w3-hoverable w3-text-blue-grey w3-centered w3-cell-middle">
			<c:forEach items="${clients}" var="client" varStatus="status">
				...
				<tr>
					...
					<td style="vertical-align: middle;">Link to modify</td>
					<td style="vertical-align: middle;"><form action="search" method="post">
